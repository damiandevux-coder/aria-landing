...
import { Activity, FileCard, Mention, Message, RunMeta, SlackFrame, Step } from "../components/slack";
...
type Job = {
  ...
  steps: Step[];
  answer: { time: string; text: React.ReactNode };
    ...
    <section id="work" className="scroll-mt-16 py-24 md:py-32">
      <div className="mx-auto max-w-[1200px] px-6 md:px-10">
        <Reveal as="header" className="max-w-2xl">
          <h2 className="text-3xl font-bold sm:text-4xl md:text-5xl">A chatbot answers. Aria hands you the work.</h2>
          <p className="mt-4 max-w-[52ch] text-lg text-fg-2">
            Four shapes of task she runs every day. Same request you&rsquo;d give a colleague, same place you&rsquo;d
            give it.
          </p>
        </Reveal>
        ...
        <div
          ...
          className="mt-10 flex gap-1 overflow-x-auto rounded-[12px] border border-line bg-ink-2/70 p-1 [scrollbar-width:none] md:inline-flex"
        >
          {jobs.map((j, i) => {
