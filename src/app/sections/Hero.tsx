  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden aurora-bg">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          Aria joins your Slack, learns your business, and starts delivering
          work in minutes. Not a tool. A hire.
        </motion.p>
        ...
        >
          <a
            href="#pricing"
            className="group inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-primary text-white font-semibold text-base hover:bg-primary/90 transition-all hover:scale-105 glow-blue"
          >
          ...
          <a
            href="#demo"
            className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border border-dark-border text-body font-semibold text-base hover:border-primary/40 hover:bg-primary/5 transition-all"
          >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#10151f] to-transparent pointer-events-none" />
    </section>
  );
}
