...
import { Activity, FileCard, Mention, Message, RunMeta, SlackFrame, TypingDots, type Step } from "./slack";
...
/*
  ...
  On mount it announces itself so the page's readiness gate can open.
*/
...
const DUR: number[] = [START_DELAY_MS, USER_TEXT.length * TYPE_MS + 450, 1100, 1300, 900, 1000, 1000, 1100, 700, 7000];
...
export default function HeroDemo() {
  ...
  // Announce mount, then wait for the page gate before the demo starts.
  useEffect(() => {
    (window as unknown as { __ariaReady?: boolean }).__ariaReady = true;
    window.dispatchEvent(new Event("aria:ready"));
